...
- `receita-web` deve ser tratado como modo assistido e experimental: navegador visível, sujeito a bloqueio anti-bot e sem promessa de automação robusta em lote.
